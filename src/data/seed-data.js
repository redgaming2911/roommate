...
export const invoices = [
  { id: 'i1', roomId: 'r1', total: 2500000, status: INVOICE_STATUS.UNPAID },
  { id: 'i2', roomId: 'r4', total: 2600000, status: INVOICE_STATUS.PARTIAL },
  { id: 'i3', roomId: 'r5', total: 2400000, status: INVOICE_STATUS.PAID },
  { id: 'i4', roomId: 'r7', total: 2800000, status: INVOICE_STATUS.OVERDUE },
  { id: 'i5', roomId: 'r9', total: 2300000, status: INVOICE_STATUS.UNPAID },
  { id: 'i6', roomId: 'r10', total: 2200000, status: INVOICE_STATUS.PAID },
  { id: 'i7', roomId: 'r1', total: 2600000, status: INVOICE_STATUS.PARTIAL },
  { id: 'i8', roomId: 'r4', total: 2550000, status: INVOICE_STATUS.UNPAID },
  { id: 'i9', roomId: 'r5', total: 2450000, status: INVOICE_STATUS.OVERDUE },
  { id: 'i10', roomId: 'r7', total: 2750000, status: INVOICE_STATUS.PAID }
];

// ===== PAYMENTS =====
export const payments = [
  { id: 'p1', invoiceId: 'i2', amount: 1000000, method: PAYMENT_METHOD.CASH },
  { id: 'p2', invoiceId: 'i3', amount: 2400000, method: PAYMENT_METHOD.BANK_TRANSFER },
  { id: 'p3', invoiceId: 'i6', amount: 2200000, method: PAYMENT_METHOD.MOMO },
  { id: 'p4', invoiceId: 'i10', amount: 2750000, method: PAYMENT_METHOD.ZALOPAY },
  { id: 'p5', invoiceId: 'i7', amount: 1500000, method: PAYMENT_METHOD.CASH },
  { id: 'p6', invoiceId: 'i2', amount: 500000, method: PAYMENT_METHOD.CASH },
  { id: 'p7', invoiceId: 'i8', amount: 1000000, method: PAYMENT_METHOD.BANK_TRANSFER },
  { id: 'p8', invoiceId: 'i5', amount: 500000, method: PAYMENT_METHOD.CASH }
];